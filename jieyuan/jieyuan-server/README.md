...
grpcurl -plaintext -proto hetu_iam/v1/user.proto \
  ...
  -d '{"id":1}' \
  localhost:58010 hetu_iam.v1.User/Find
...
grpcurl -plaintext -proto hetu_iam/v1/role.proto \
  ...
  localhost:58010 hetu_iam.v1.Role/Create
...
grpcurl -plaintext -proto hetu_iam/v1/role.proto \
  ...
  localhost:58010 hetu_iam.v1.Role/Get
...
grpcurl -plaintext -proto hetu_iam/v1/access_control.proto \
  ...
  localhost:58010 hetu_iam.v1.AccessControl/CreatePolicyStatement
...
grpcurl -plaintext -proto hetu_iam/v1/access_control.proto \
  ...
  localhost:58010 hetu_iam.v1.AccessControl/GetPolicyStatement
```
