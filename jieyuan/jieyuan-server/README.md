...
grpcurl -plaintext -import-path ./fusions/fusion-iam/proto \
  -proto ultimate_iam/v1/auth.proto \
  -d '{"email":"admin@fusiondata.com", "password":"2024.Fusiondata"}' \
  localhost:58010 ultimate_iam.v1.Auth/Signin


grpcurl -plaintext -proto ultimate_iam/v1/user.proto \
  ...
  -d '{"id":1}' \
  localhost:58010 ultimate_iam.v1.User/Find


grpcurl -plaintext -proto ultimate_iam/v1/role.proto \
  -import-path ./fusions/fusion-iam/proto \
  -import-path ./ultimates/ultimate-api/proto \
  -H 'Authorization: Bearer eyJ0eXAiOiJKV1QiLCJlbmMiOiJBMTI4Q0JDLUhTMjU2IiwiYWxnIjoiZGlyIn0..tEzlNmgpceHjDcW0mEAlCg.elEEVDBlz5aINB-HyoPolE8ahROWw-aZdxMN2bPIXAY.i5WYuPGJbHKR8_F1F55uhw' \
  -d '{
  ...
  localhost:58010 ultimate_iam.v1.Role/Create
...
grpcurl -plaintext -proto ultimate_iam/v1/role.proto \
  ...
  localhost:58010 ultimate_iam.v1.Role/Get


grpcurl -plaintext -proto ultimate_iam/v1/access_control.proto \
  -import-path ./fusions/fusion-iam/proto \
  -import-path ./ultimates/ultimate-api/proto \
  -H 'Authorization: Bearer eyJ0eXAiOiJKV1QiLCJlbmMiOiJBMTI4Q0JDLUhTMjU2IiwiYWxnIjoiZGlyIn0..tEzlNmgpceHjDcW0mEAlCg.elEEVDBlz5aINB-HyoPolE8ahROWw-aZdxMN2bPIXAY.i5WYuPGJbHKR8_F1F55uhw' \
  -d '{
  ...
  localhost:58010 ultimate_iam.v1.AccessControl/CreatePolicyStatement
...
grpcurl -plaintext -proto ultimate_iam/v1/access_control.proto \
  ...
  localhost:58010 ultimate_iam.v1.AccessControl/GetPolicyStatement
```
