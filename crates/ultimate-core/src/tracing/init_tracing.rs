...
use crate::{
  DataError, Result,
  configuration::{LogLevel, LogSetting, LogWriterType, UltimateSetting},
};
...
pub fn init_subscribers(setting: &UltimateSetting) -> Result<Option<Guard>> {
