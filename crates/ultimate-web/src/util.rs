...
use ultimate_common::model::IdI64Result;
use ultimate_common::time::now_offset;
use ultimate_core::configuration::SecuritySetting;
use ultimate_core::security::{AccessToken, SecurityUtils};
use ultimate_core::utils::get_trace_id;
...
#[cfg(feature = "with-ulid")]
#[inline]
pub fn ok_ulid(id: Ulid) -> WebResult<ultimate_common::model::IdUlidResult> {
  Ok(ultimate_common::model::IdUlidResult::new(id).into())
}

#[inline]
pub fn ok_uuid(id: uuid::Uuid) -> WebResult<ultimate_common::model::IdUuidResult> {
  Ok(ultimate_common::model::IdUuidResult::new(id).into())
}
