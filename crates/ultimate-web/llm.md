...
> fusion-web 是 Fusion-Data 项目的 Web 层封装，基于 Axum 框架，提供 Router、WebServerBuilder、中间件等工具。
...
```rust
use ultimate_web::extract::JsonOrForm;
...
```rust
use ultimate_web::middleware::WebAuth;
...
```rust
use ultimate_core::{DataError, application::Application, logforth::LogforthPlugin};
