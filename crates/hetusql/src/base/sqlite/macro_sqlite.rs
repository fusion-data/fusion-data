	...
	(
		...
		impl $struct_name {
			...
			pub async fn find_by_id(
				...
				hetusql::base::sqlite_find_by_id::<Self, _>(mm, id.into()).await
			}
			...
			pub async fn get_by_id(
				...
				hetusql::base::sqlite_get_by_id::<Self, _>(mm, id.into()).await
			}
	...
	(
		...
		impl $struct_name {
			pub async fn find_unique(
				...
				hetusql::base::sqlite_find_unique::<Self, _, _>(mm, filter).await
			}
			...
			pub async fn find_many(
				...
				hetusql::base::sqlite_find_many::<Self, _, _>(mm, filter, page).await
			}
			...
			pub async fn page(
				...
				hetusql::base::sqlite_page::<Self, _, _>(mm, filter, page).await
			}
