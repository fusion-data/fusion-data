...
impl_array_op_val!(
  (OpValsArrayInt64, OpValArrayInt64, Vec<i64>, OpVal::ArrayInt64),
  (OpValsArrayInt32, OpValArrayInt32, Vec<i32>, OpVal::ArrayInt32),
  (OpValsArrayFloat64, OpValArrayFloat64, Vec<f64>, OpVal::ArrayFloat64),
  (OpValsArrayString, OpValArrayString, Vec<String>, OpVal::ArrayString)
);
