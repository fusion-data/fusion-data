...
pub fn get_modelsql_field_props_and_skips<'a>(fields: &'a FieldsNamed) -> ModqlFieldsAndSkips<'a> {
  ...
  ModqlFieldsAndSkips { modelsql_fields: modql_fields, skipped_fields, field_mask_field }
}
