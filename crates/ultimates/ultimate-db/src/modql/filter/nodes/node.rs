use crate::modql::filter::ops::OpVal;
use crate::modql::filter::{OpValBool, OpValFloat64, OpValInt32, OpValInt64, OpValString};
...
pub struct FilterNode {
  ...
  pub for_sea_condition: Option<crate::modql::filter::ForSeaCondition>,
}
...
mod with_sea_query {
  use super::*;
  use crate::modql::filter::{ForSeaCondition, IntoSeaError, OpValValue, SeaResult};
