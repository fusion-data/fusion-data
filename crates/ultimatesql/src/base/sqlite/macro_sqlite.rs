	...
	(
		...
		impl $struct_name {
			...
			pub async fn find_by_id(
				...
				ultimatesql::base::sqlite_find_by_id::<Self, _>(mm, id.into()).await
			}
			...
			pub async fn get_by_id(
				...
				ultimatesql::base::sqlite_get_by_id::<Self, _>(mm, id.into()).await
			}
	...
	(
		...
		impl $struct_name {
			pub async fn find_unique(
				...
				ultimatesql::base::sqlite_find_unique::<Self, _, _>(mm, filter).await
			}
			...
			pub async fn find_many(
				...
				ultimatesql::base::sqlite_find_many::<Self, _, _>(mm, filter, page).await
			}
			...
			pub async fn page(
				...
				ultimatesql::base::sqlite_page::<Self, _, _>(mm, filter, page).await
			}
  ...
  (
    ...
    impl $struct_name {
      pub async fn get_filter(
        ...
        ultimatesql::base::sqlite_get_filter::<Self, _, _>(mm, filter).await
      }
    }
  };
}
