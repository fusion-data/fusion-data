...
//! Example:
//! ```rust
//! use hetu_ai::graph_flow::{Context, Task, TaskResult, NextAction};
//! use hetu_ai::graph_flow::fanout::FanOutTask;
...
//!     async fn run(&self, ctx: Context) -> hetu_ai::graph_flow::Result<TaskResult> {
