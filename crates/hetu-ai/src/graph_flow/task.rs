...
///
/// ```rust
/// use hetu_ai::graph_flow::{TaskResult, NextAction};
///
/// // Basic task result
...
///
/// ```rust
/// use hetu_ai::graph_flow::{NextAction, TaskResult};
///
...
///
/// ```rust
/// # use hetu_ai::graph_flow::{Task, TaskResult, NextAction, Context, GraphError};
/// # use async_trait::async_trait;
...
pub trait Task: Send + Sync {
  ...
  ///
  /// ```rust
  /// # use hetu_ai::graph_flow::Task;
  /// # use async_trait::async_trait;
  /// # use hetu_ai::graph_flow::{TaskResult, NextAction, Context};
  ...
  ///     async fn run(&self, _context: Context) -> hetu_ai::graph_flow::Result<TaskResult> {
  ///         Ok(TaskResult::new(None, NextAction::End))
  ///     }
  /// }
  ///
  ...
  ///
  /// impl DataProcessor {
  ///     async fn process_data(&self, input: &str) -> hetu_ai::graph_flow::Result<String> {
...
mod tests {
  ...
  fn test_default_id_implementation() {
    ...
    assert_eq!(task.id(), "hetu_ai::graph_flow::task::tests::TestTaskWithDefaultId");
  }
