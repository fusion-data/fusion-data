...
use super::{
  User, UserBmc, UserCredential, UserCredentialBmc, UserFilter, UserForCreate, UserForPage, UserForUpdate,
...
impl UserSvc {
  ...
  pub async fn page(&self, ctx: &CtxW, req: UserForPage) -> Result<PageResult<User>> {
