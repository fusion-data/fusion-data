...
```rust
use fusion_ai::factory::{AgentConfig, ClientFactory};
...
```rust
use fusion_ai::agents::AgentConfig;
...
### EmbeddingConfig
```rust
use fusion_ai::factory::{EmbeddingConfig, ClientFactory};
...
### Embeddings 封装
```rust
use fusion_ai::embeddings::{EmbeddingConfig, Embeddings};
...
### GraphBuilder
```rust
use fusion_ai::graph_flow::{GraphBuilder, Task, NextAction};
use std::sync::Arc;
...
### FlowRunner
```rust
use fusion_ai::graph_flow::{FlowRunner, InMemorySessionStorage, Session};
...
```rust
// 内存存储 (开发/测试)
use fusion_ai::graph_flow::InMemorySessionStorage;
let storage = Arc::new(InMemorySessionStorage::new());

// PostgreSQL 存储 (生产)
use fusion_ai::graph_flow::PostgresSessionStorage;
...
```rust
fusion_ai::DefaultProviders::ANTHROPIC        // "anthropic"
fusion_ai::DefaultProviders::COHERE           // "cohere"
fusion_ai::DefaultProviders::GEMINI           // "gemini"
fusion_ai::DefaultProviders::HUGGINGFACE      // "huggingface"
fusion_ai::DefaultProviders::OPENAI           // "openai"
fusion_ai::DefaultProviders::OPENAI_COMPATIBLE // "openai-compatible"
fusion_ai::DefaultProviders::OPENROUTER       // "openrouter"
fusion_ai::DefaultProviders::TOGETHER         // "together"
fusion_ai::DefaultProviders::XAI              // "xai"
fusion_ai::DefaultProviders::AZURE            // "azure"
fusion_ai::DefaultProviders::DEEPSEEK         // "deepseek"
fusion_ai::DefaultProviders::MISTRAL          // "mistral"
fusion_ai::DefaultProviders::OLLAMA           // "ollama"
fusion_ai::DefaultProviders::PERPLEXITY       // "perplexity"
```
