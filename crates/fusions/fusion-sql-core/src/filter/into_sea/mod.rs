...
pub type ToSeaConditionFn = fn(col: &ColumnRef, op_value: OpValsValue) -> SeaResult<Vec<ConditionExpression>>;
...
impl ToSeaConditionFnHolder {
  ...
  pub fn call(&self, col: &ColumnRef, op_value: OpValsValue) -> SeaResult<Vec<ConditionExpression>> {
