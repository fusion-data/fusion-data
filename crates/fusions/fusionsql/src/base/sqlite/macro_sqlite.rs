	...
	(
		...
		impl $struct_name {
			...
			pub async fn find_by_id(
				...
				fusionsql::base::sqlite_find_by_id::<Self, _>(mm, id.into()).await
			}
			...
			pub async fn get_by_id(
				...
				fusionsql::base::sqlite_get_by_id::<Self, _>(mm, id.into()).await
			}
	...
	(
		...
		impl $struct_name {
			pub async fn find_unique(
				...
				fusionsql::base::sqlite_find_unique::<Self, _, _>(mm, filter).await
			}
