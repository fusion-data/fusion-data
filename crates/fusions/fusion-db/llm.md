...
use fusion_core::ApplicationBuilder;
...
### 完整应用启动流程
```rust
use fusion_core::{Application, ApplicationBuilder, logforth::LogforthPlugin};
use fusion_db::DbPlugin;
