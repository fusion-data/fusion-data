...
mod tests {
  ...
  fn test_config_load() {
    // 使用自定义环境变量源，确保测试隔离
    set_env("HETU__WEB__SERVER_ADDR", "0.0.0.0:8000").unwrap();
    set_env("HETU__SECURITY__TOKEN__SECRET_KEY", "8462b1ec9af827ebed13926f8f1e5409774fa1a21a1c8f726a4a34cf7dcabaf2")
      .unwrap();
    set_env("HETU__SECURITY__PWD__PWD_KEY", "80c9a35c0f231219ca14c44fe10c728d").unwrap();
    set_env("HETU__APP__NAME", "hetu-test").unwrap();
    ...
    // 由环境变量 HETU__APP__NAME 提供
    assert_eq!(qc.app().name(), "hetu-test");
