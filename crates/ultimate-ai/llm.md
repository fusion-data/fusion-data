...
> fusion-ai 是 Fusion-Data 项目的 AI 集成库，基于 rig-core，提供多 LLM 提供商支持、Agent、Embeddings、Graph Flow 工作流等功能。
...
```rust
use ultimate_ai::factory::{AgentConfig, ClientFactory};
...
```rust
use ultimate_ai::agents::AgentConfig;
...
```rust
use ultimate_ai::factory::{EmbeddingConfig, ClientFactory};
...
```rust
use ultimate_ai::embeddings::{EmbeddingConfig, Embeddings};
...
```rust
use ultimate_ai::graph_flow::{Task, TaskResult, NextAction, Context};
...
impl Task for HelloTask {
  ...
  async fn run(&self, context: Context) -> ultimate_ai::graph_flow::Result<TaskResult> {
...
```rust
use ultimate_ai::graph_flow::Context;
...
```rust
use ultimate_ai::graph_flow::{GraphBuilder, Task, NextAction};
use std::sync::Arc;
...
```rust
use ultimate_ai::graph_flow::{FlowRunner, InMemorySessionStorage, Session};
...
```rust
// 内存存储 (开发/测试)
use ultimate_ai::graph_flow::InMemorySessionStorage;
let storage = Arc::new(InMemorySessionStorage::new());

// PostgreSQL 存储 (生产)
use ultimate_ai::graph_flow::PostgresSessionStorage;
...
```rust
ultimate_ai::DefaultProviders::ANTHROPIC        // "anthropic"
ultimate_ai::DefaultProviders::COHERE           // "cohere"
ultimate_ai::DefaultProviders::GEMINI           // "gemini"
ultimate_ai::DefaultProviders::HUGGINGFACE      // "huggingface"
ultimate_ai::DefaultProviders::OPENAI           // "openai"
ultimate_ai::DefaultProviders::OPENAI_COMPATIBLE // "openai-compatible"
ultimate_ai::DefaultProviders::OPENROUTER       // "openrouter"
ultimate_ai::DefaultProviders::TOGETHER         // "together"
ultimate_ai::DefaultProviders::XAI              // "xai"
ultimate_ai::DefaultProviders::AZURE            // "azure"
ultimate_ai::DefaultProviders::DEEPSEEK         // "deepseek"
ultimate_ai::DefaultProviders::MISTRAL          // "mistral"
ultimate_ai::DefaultProviders::OLLAMA           // "ollama"
ultimate_ai::DefaultProviders::PERPLEXITY       // "perplexity"
```
