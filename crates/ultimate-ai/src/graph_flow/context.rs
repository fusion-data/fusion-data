...
///
/// ```rust
/// use ultimate_ai::graph_flow::{SerializableMessage, MessageRole};
///
...
impl SerializableMessage {
  ...
  ///
  /// ```rust
  /// use ultimate_ai::graph_flow::SerializableMessage;
  ///
...
///
/// ```rust
/// use ultimate_ai::graph_flow::ChatHistory;
///
...
impl Context {
  ...
  ///
  /// ```rust
  /// use ultimate_ai::graph_flow::{Context, GraphBuilder};
  ///
  /// # #[tokio::main]
  /// # async fn main() {
  /// let context = Context::new();
