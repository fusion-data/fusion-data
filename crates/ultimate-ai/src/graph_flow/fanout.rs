...
//! Example:
//! ```rust
//! use ultimate_ai::graph_flow::{Context, Task, TaskResult, NextAction};
//! use ultimate_ai::graph_flow::fanout::FanOutTask;
...
//!     async fn run(&self, ctx: Context) -> ultimate_ai::graph_flow::Result<TaskResult> {
