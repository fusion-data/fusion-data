...
//!
//! ```sh
//! cargo run -p hetu-security --features="with-oauth" --example github-async
//! ```
//!
...
use hetus::security::oauth2::basic::BasicClient;
use hetus::security::oauth2::reqwest;
use hetus::security::oauth2::{
