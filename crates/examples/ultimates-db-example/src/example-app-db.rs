...
use ultimates::core::{application::Application, component::ComponentArc};
use ultimates::db::{DbPlugin, ModelManager};
...
impl TestSvc {
  pub async fn test(&self) -> ultimates::core::Result<String> {
    let _mm = &self.mm;
