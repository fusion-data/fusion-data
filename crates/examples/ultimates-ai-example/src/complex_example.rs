...
impl Task for SentimentAnalysisTask {
  async fn run(&self, context: Context) -> ultimates::ai::graph_flow::Result<TaskResult> {
...
impl SentimentAnalysisTask {
  ...
  async fn dummy_sentiment(
    ...
    context: Context,
    user_input: String,
  ) -> ultimates::ai::graph_flow::Result<TaskResult> {
...
impl Task for PositiveResponseTask {
  async fn run(&self, _context: Context) -> ultimates::ai::graph_flow::Result<TaskResult> {
