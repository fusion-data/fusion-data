...
use ultimates::common::time::UtcDateTime;
use ultimates::core::{application::ApplicationBuilder, component::ComponentInstaller};
...
impl ComponentInstaller for ExampleRegistrar {
  ...
  fn install_component(&self, _app: &mut ApplicationBuilder) -> ultimates::core::Result<()> {
    todo!()
  }
}

ultimates::core::component::submit!(&ExampleRegistrar as &dyn ComponentInstaller);
