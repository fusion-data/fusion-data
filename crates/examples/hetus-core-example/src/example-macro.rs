...
use hetus::common::time::UtcDateTime;
use hetus::core::{application::ApplicationBuilder, component::ComponentInstaller};
...
impl ComponentInstaller for ExampleRegistrar {
  ...
  fn install_component(&self, _app: &mut ApplicationBuilder) -> hetus::core::Result<()> {
    todo!()
  }
}

hetus::core::component::submit!(&ExampleRegistrar as &dyn ComponentInstaller);
